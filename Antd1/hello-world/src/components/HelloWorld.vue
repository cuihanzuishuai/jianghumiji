<template>
  <div>
    ...
    >
      <a-form-model-item ref="name" :required="needVld" label="Activity name" prop="name">
...
() => {
  ...
  " />
    ...
    <a-button @click="changeVld">change</a-button>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    changeVld() {
      this.needVld = true
      // this.$ruleForm.validateField('name')
      // console.log('this.needVld', this.needVld)
    },
    onSubmit() {
